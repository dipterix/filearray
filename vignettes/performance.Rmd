...
#> Unit: seconds
#>    expr  min   lq mean median   uq  max neval
#>  double 1.59 1.62 1.63   1.64 1.64 1.65     3
#>   float 1.36 1.39 1.45   1.43 1.49 1.56     3
```
...
#> Unit: seconds
#>    expr   min    lq  mean median    uq   max neval
#>  double 0.971 0.975 0.983  0.980 0.988 0.997     3
#>   float 0.764 0.779 0.825  0.794 0.855 0.916     3
```
...
#> Unit: milliseconds
#>                          expr   min    lq  mean median    uq    max neval
#>  farr_double_partition_margin  1.83  2.58  3.45   2.89  3.99  10.38   100
#>       farr_double_fast_margin  1.30  1.82  2.46   2.09  2.90   5.68   100
#>       farr_double_slow_margin 22.62 24.46 35.82  26.61 30.71 228.23   100
#>   farr_float_partition_margin  1.61  2.35  5.68   2.88  4.06  82.45   100
#>        farr_float_fast_margin  1.27  1.64  2.75   1.90  3.23  34.53   100
#>        farr_float_slow_margin 15.14 16.40 25.72  17.68 19.52 155.64   100
#>       native_partition_margin  3.44  3.93  4.34   4.15  4.56   9.35   100
#>            native_fast_margin  3.53  4.01  4.40   4.20  4.65   6.76   100
#>            native_slow_margin 21.52 22.46 27.01  23.16 26.67 130.66   100
```
