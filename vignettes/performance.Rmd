...
#> Unit: seconds
#>   expr  min   lq mean median   uq  max neval
#> double 1.29 1.45 1.50   1.60 1.61 1.61     3
#>  float 1.34 1.65 1.84   1.97 2.10 2.23     3
```
...
#> Unit: seconds
#>         expr   min    lq  mean median    uq   max neval
#>  farr_double 0.681 0.692 1.052  1.030 1.133 1.724     5
#>   farr_float 0.645 0.650 0.771  0.662 0.711 1.189     5
#>       native 0.967 1.079 1.085  1.115 1.131 1.133     5
#>      dipsaus 0.183 0.186 0.206  0.205 0.226 0.231     5
```
