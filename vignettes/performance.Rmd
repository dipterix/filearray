...
#> Unit: seconds
#>         expr       min        lq      mean    median        uq       max neval
#>  farr_double 0.6731775 0.6958329 0.9363764 0.9568852 1.1093089 1.2466774     5
#>   farr_float 0.6653586 0.6669888 0.7580738 0.7696540 0.7878815 0.9004861     5
#>       native 1.3795231 1.4347390 1.4967604 1.4747100 1.5183895 1.6764403     5
#>      dipsaus 0.1991483 0.2097805 0.2609299 0.2138676 0.3054480 0.3764052     5
```

The `dipsaus` package uses multiple threads to collapse arrays in-memory. It is `7x` as fast as base R. File array is `1.5~2x` as fast as base R. Both `dipsaus` and `filearray` use little extra memories.
